...
from slambook.views import (test_ajax,Questions,base_t,index_t,character_tlist,
                            delete_char_t,EditTemplateName,CreateTemplate,
                            main_t,cquestion_tlist,delete_cquestion_t,
                            EditCQuestion,CreateCQuestion,delete_RCQT_t,
                            RCQT_tlist,add_RCQT_t,slams_list,CreateSlams,
                            EditSlamsName,delete_slams,list_slam,delete_slam,
                            add_slam,generate_slam,list_user,send_slam,Inbox,
                            Sent,Response,delete_inbox,delete_sent,view_slam,
                            edit_slam,response_slam,view_response,profile_view,
                            Gift_view,generate_gift,search_user,GiftReceiver_view,
                            delete_gifts,Add_User_to_Group,add_gift,Gift_Creator,
                            Gift_Creator_Content,Group_view,Delete_Group,
...
urlpatterns = [
    ...
    #Notification URLs
     url(r'^notifications/',login_required(Notifications_view.as_view()),name="Notifications"),
